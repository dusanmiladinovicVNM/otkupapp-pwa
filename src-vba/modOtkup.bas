...
Public Function IspravkaOtkupa_TX(ByVal stariOtkupID As String, _
    ...
    ' Nacrt u ISTOM potezu prelazi na naslednika (S3d-2). Ide POSLE upisa novog
    ' dokumenta -- naslednik mora da postoji da bi prosao kapije izvora.
    If Len(roditelj) > 0 Then
...
' SaveOtkupMulti_TX, SaveOtkup_TX i SaveOtkup SU OBRISANI (S1a, plan S14.10).
'
' Bili su pisci po klasi: jedan unos je davao red po klasi u tblOtkup, sa
' kolicinom i cenom na ZAGLAVLJU. Jedini pisac je CreateOtkup_TX (zaglavlje +
' stavke). Test kome treba zaglavlje BEZ STAVKI (oblik koji kapije odbijaju)
' pravi ga kao sinteticku anomaliju: CreateOtkup_TX pa brisanje stavki u
' transakciji testa (modBusinessFlowProTests.OtkupBezStavkiFixture).
