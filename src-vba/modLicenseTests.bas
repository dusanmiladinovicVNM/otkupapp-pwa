...
' ============================================================
' modLicenseTests aEUR" unit testovi za cistu logiku modLicense.
'
' Pokreni: Alt+F8 -> TestLicense_All  (rezultati u Immediate / Ctrl+G)
'
' Testira fuzzy-match logiku otiska (LicSplitParts / LicPartsMatch /
' LicNonEmptyParts) koja odlucuje da li je masina "ista" aEUR" to je deo gde
...
Public Sub TestLicense_SplitParts()
    Debug.Print vbCrLf & "[1] LicSplitParts aEUR" padding na 3"
    Dim p() As String
...
Public Sub TestLicense_PartsMatch()
    Debug.Print vbCrLf & "[2] LicPartsMatch aEUR" broj poklapanja"
...
Public Sub TestLicense_NonEmptyParts()
    Debug.Print vbCrLf & "[3] LicNonEmptyParts aEUR" ne-prazne komponente"
