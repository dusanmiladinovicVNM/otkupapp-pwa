...
Private Sub UserForm_Activate()
    ...
    StyleSubtitle lblSubtitle, "Operativni unos dokumenata, ambala�e i novca"
...
EH:
    ...
    MsgBox "Gre�ka pri otvaranju dokumenata: " & Err.description, vbCritical, APP_NAME
End Sub
...
Private Sub cmbFakturaIzlaz_Change()
    ...
    If cmbFakturaIzlaz.value = "" Then
        lblManjak.caption = ""        ' kupacSaldo dummy � ako ima� zaseban label, zameni
        Exit Sub
    End If
...
Private Sub btnUnosOtp_Click()
    ...
    Else
        ...
        If txtKolAmbOtp.value <> "" Then
            MsgBox "Unosi se samo II klasa: obri�ite kolicinu ambala�e za I klasu.", _
    ...
    If txtKolAmbOtp.value <> "" Then
        If Not TryParseLong(txtKolAmbOtp.value, kolAmb) Then
            MsgBox "Unesite ispravnu kolicinu ambala�e!", vbExclamation, APP_NAME
            txtKolAmbOtp.SetFocus
            Exit Sub
        End If
    End If
    ...
    If chkDveKlaseOtp.value And Not m_txtKolAmbIIOtp Is Nothing Then
        If Trim$(m_txtKolAmbIIOtp.value) <> "" Then
            If Not TryParseLong(m_txtKolAmbIIOtp.value, kolAmbII) Then
                MsgBox "Unesite ispravnu kolicinu ambala�e za II klasu!", vbExclamation, APP_NAME
    ...
    If OtkupBrutoUnos() And kolAmb > 0 Then
        ...
        If taraKg <= 0 Then
            MsgBox "Tip ambala�e '" & cmbTipAmbOtp.value & "' nema unetu te�inu gajbice " & _
                   "(Maticni podaci ? Tip ambala�e)." & vbCrLf & _
                   "Bruto se ne mo�e pretvoriti u neto.", vbExclamation, APP_NAME
            cmbTipAmbOtp.SetFocus
            Exit Sub
        End If
        If taraKg >= kolicinaI Then
            MsgBox "Te�ina ambala�e (" & Format$(taraKg, "#,##0.00") & " kg) je veca ili " & _
                   "jednaka bruto te�ini (" & Format$(kolicinaI, "#,##0.00") & " kg)." & vbCrLf & _
                   "Proverite broj komada ili tip ambala�e.", vbExclamation, APP_NAME
            txtKolicinaOtp.SetFocus
            Exit Sub
        End If
    ...
    If chkDveKlaseOtp.value And OtkupBrutoUnos() And kolAmbII > 0 Then
        ...
        If taraKgII <= 0 Then
            MsgBox "Tip ambala�e '" & cmbTipAmbOtp.value & "' nema unetu te�inu gajbice " & _
                   "(Maticni podaci ? Tip ambala�e)." & vbCrLf & _
                   "Bruto (II klasa) se ne mo�e pretvoriti u neto.", vbExclamation, APP_NAME
            cmbTipAmbOtp.SetFocus
            Exit Sub
        End If
        If taraKgII >= kolicinaII Then
            MsgBox "Te�ina ambala�e II klase (" & Format$(taraKgII, "#,##0.00") & " kg) je veca ili " & _
                   "jednaka bruto te�ini (" & Format$(kolicinaII, "#,##0.00") & " kg).", vbExclamation, APP_NAME
    ...
    If result = "" Then
        MsgBox "Gre�ka pri cuvanju otpremnice. Promene su vracene.", vbCritical, APP_NAME
        Exit Sub
    End If
...
EH:
    ...
    MsgBox "Gre�ka: " & Err.description, vbCritical, APP_NAME
End Sub
Private Sub ClearOtpremnicaFields()
    ...
    RefreshBrojOtpSuggestion   ' ? DODATO: predlo�i sledeci za istu stanicu/datum
End Sub

Private Sub RefreshBrojOtpSuggestion()
    ' Predla�e BrojOtpremnice. OTP je VBA-only � scan samo tblOtpremnica.
    On Error GoTo EH
...
Private Sub RefreshBrojZbirneSuggestion()
    ' Predla�e BrojZbirne. ZBR scan = tblZbirna + VOZ-{vozacID} sheet.
    On Error GoTo EH
...
Public Function SaveOMUlaz_TX(ByVal datum As Date, _
    ...
    If kolAmb <= 0 And novac <= 0 Then
        Err.Raise vbObjectError + 1501, "SaveOMUlaz_TX", _
                  "Nema ambala�e ni novca za cuvanje."
    End If
...
Private Sub btnUnosOMUlaz_Click()
    ...
    If kolAmb <= 0 And novac <= 0 Then
        MsgBox "Unesite ambala�u ili novac za OM ulaz.", vbExclamation, APP_NAME
        Exit Sub
    End If

    If kolAmb > 0 And cmbTipAmbOMUlaz.value = "" Then
        MsgBox "Izaberite tip ambala�e!", vbExclamation, APP_NAME
        Exit Sub
    End If
            ...
            If cmbOtkupBlok.ListIndex >= 0 Then
                ...
                If tglIzOMAvansa.value Then
                    ...
                    If novac > omSaldo Then
                        MsgBox "Nedovoljno OM avansa! Raspolo�ivo: " & _
    ...
    If Not SaveOMUlaz_TX( _
        ...
        MsgBox "Gre�ka pri cuvanju OM ulaza. Promene su vracene.", vbCritical, APP_NAME
        Exit Sub
    End If
...
Private Sub btnUnosZbr_Click()
    ...
    If Not UpdateValidacija() Then
        MsgBox "Validacija nije pro�la. Proverite kg i ambala�u (razlika mora biti 0).", vbExclamation, APP_NAME
        Exit Sub
    End If
    ...
    If result = "" Then
        MsgBox "Gre�ka pri cuvanju zbirne. Promene su vracene.", vbCritical, APP_NAME
        Exit Sub
    End If
    ...
    ' Predlo�i sledeci broj za istog vozaca/datum
    RefreshBrojZbirneSuggestion
    Exit Sub
...
Private Function UpdateValidacija() As Boolean
    ...
    If Trim$(txtUkupnoAmbZbr.value) <> "" Then
        If Not TryParseLong(txtUkupnoAmbZbr.value, inputAmb) Then
            lblValidacijaAmb.caption = "Neispravna kolicina ambala�e"
...
Private Sub btnUnosPrij_Click()
    ...
    If Trim$(txtKolAmbVracena.value) <> "" Then
        If Not TryParseLong(txtKolAmbVracena.value, kolAmbVracena) Then
            MsgBox "Unesite ispravnu kolicinu vracene ambala�e!", vbExclamation, APP_NAME
    ...
    If OtkupBrutoUnos() And kolAmb > 0 Then
        ...
        If taraKg <= 0 Then
            MsgBox "Tip ambala�e '" & cmbTipAmbPrij.value & "' nema unetu te�inu gajbice " & _
                   "(Maticni podaci ? Tip ambala�e)." & vbCrLf & _
                   "Bruto se ne mo�e pretvoriti u neto.", vbExclamation, APP_NAME
    ...
    If result = "" Then
        MsgBox "Gre�ka pri cuvanju prijemnice. Promene su vracene.", vbCritical, APP_NAME
        Exit Sub
    End If
...
Private Sub btnUnosIzlaz_Click()
    ...
    If kolAmb <= 0 And novac <= 0 Then
        MsgBox "Unesite ambala�u ili uplatu kupca.", vbExclamation, APP_NAME
        Exit Sub
    End If
    ...
    If Not SaveKupciIzlaz_TX( _
        ...
        MsgBox "Gre�ka pri cuvanju izlaza kupca. Promene su vracene.", vbCritical, APP_NAME
        Exit Sub
    End If
...
Private Sub SetupFkeyHints()
    On Error Resume Next
    ' Poku�aj da nade i stilizuje F-key hint label-e ako ih doda� u Designer:
