Attribute VB_Name = "modScrMatProizvodnja"
'=====================================================================
' modScrMatProizvodnja - ekran "Proizvodnja" (sekcija MATICNI, Prerada 2.0
' Faza A).
'
' Tri liste: Proizvodi, Tipovi procesa, Oprema -- sifarnici proizvodnog
' jezgra (docs/PRERADA_2_MODEL_I_PLAN.md par. 4.1-4.3). Proizvodi i tipovi
' procesa se i SEJU (modProizvodnja); ovde se dopunjuju i gase.
'
' Modul je TANAK NAMERNO (isti obrazac kao modScrMatPakovanje): sve o
' podacima zna modMaticniIzvor, sve o zoni i dogadjajima modMaticniEkran.
' Ovde stoji samo koje sekcije ekran nosi.
'
' Fajl mora ostati 100% ASCII.
'=====================================================================
Option Explicit

Public Const SCRMPZ_BUILD As String = "v6-ui-210"

Private Const EKRAN As String = "MAT_PROIZVODNJA"

Private mLista As String

Public Function Scr_Meta() As String
    Scr_Meta = "kljuc=" & EKRAN & "|naslov=OTKUI_NAV_MAT_PROIZVODNJA|sub=OTKUI_SCRMPZ_SUB" & _
               "|lista=OTKUI_GTM_PRZ|oblik=zona+mreza|upis=zona"
End Function
...
' Ljuska javlja da se ekran napusta -- editor i izbor odlaze s njim.
...
'------------------------------------------------------------ TEST SEAM
Public Sub Scr_MpzTestSet(ByVal lista As String)
    mLista = lista
End Sub
