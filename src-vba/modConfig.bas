...
Public Const APP_VERSION As String = "2.28.4"
...
' bira racun u frmBankaExportPregled ("Sa racuna"). Izvor istine su cetiri zasebna
' polja u Podesavanjima (grupa "Banka / nalozi"): CFG_BANKA_NALOG_RACUN_1..4.
...
Public Const CFG_BANKA_NALOG_RACUN_4 As String = "BANKA_NALOG_RACUN_4"
