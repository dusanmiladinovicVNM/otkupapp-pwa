...
'
' Danas ugovor ispunjava samo ekran dokumenata. Ostali su u registru sa
' svojim modulom koji jos ne postoji - sidebar ih prikazuje prigusene.
'
' Fajl mora ostati 100% ASCII.
'=====================================================================
Option Explicit

Public Const UISCR_BUILD As String = "v6-ui-71"
