...
Private Sub UpsertPoruke02(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_SPLASH_LICENCA", "Provera licence" & ChrW(8230)
    UpsertRow lo, existing, "OTKUI_SPLASH_VERZIJA", "Provera verzije" & ChrW(8230)
    UpsertRow lo, existing, "OTKUI_SPLASH_EKRAN", "U" & ChrW(269) & "itavam ekran" & ChrW(8230)
...
Private Sub UpsertPoruke05(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_MNJ_ZBIRNA", "ZBIRNA"
    UpsertRow lo, existing, "OTKUI_MNJ_PRIJEM", "PRIJEM"
    UpsertRow lo, existing, "OTKUI_MNJ_MANJAK", "MANJAK"
    UpsertRow lo, existing, "OTKUI_MNJ_PROSEK", "PROSEK GAJBE"
    ...
    UpsertRow lo, existing, "OTKUI_FT_AMB_ULAZ", "Ulaz"
    UpsertRow lo, existing, "OTKUI_FT_AMB_IZLAZ", "Izlaz"
...
Private Sub UpsertPoruke06(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "STORNO_ERR_REV_KLJUC", ChrW(10007) & " Revers se ne mo" & ChrW(382) & _
              "e jednozna" & ChrW(269) & "no odrediti:"
    UpsertRow lo, existing, "DOKUNOS_ERR_REV_KOOP_DRUGA_STANICA", ChrW(10007) & " Taj broj reversa sa " & _
              "kooperantom je ve" & ChrW(263) & " izdat tog dana, za isti smer, na drugom otkupnom mestu. " & _
              "Noga kooperanta ne nosi otkupno mesto, pa se dva takva reversa ne bi mogla razlikovati " & _
              "pri stornu " & ChrW(8212) & " izaberi drugi broj. Postoje" & ChrW(263) & "i dokument:"
...
Private Sub UpsertPoruke07(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_SEG_OPO_INT", "Integritet"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_INTEGRITET", "Neuskla" & ChrW(273) & "eni zapisi (revizija tabela)"
    UpsertRow lo, existing, "OTKUI_OPO_INT_NALAZA", "neuskla" & ChrW(273) & "enih zapisa"
...
Private Sub UpsertPoruke09(lo As ListObject, existing As Object)
    ...
    ' --- ekran Platni nalozi (Faza E, v6-ui-185) ---
    UpsertRow lo, existing, "OTKUI_SCRBN_SUB", "Otvoreni blokovi u naloge za prenos: CSV za e-banking i specifikacija"
    UpsertRow lo, existing, "OTKUI_SCRBN_LISTA", "Blokovi za isplatu"
    UpsertRow lo, existing, "OTKUI_SCRBN_CAP", "Platni nalozi"
    UpsertRow lo, existing, "OTKUI_SEG_BN_NALOZI", "Za isplatu"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_BN_NALOZI", "Otvoreni blokovi za isplatu"
    UpsertRow lo, existing, "OTKUI_CIPN_IMARAC", "Ima ra" & ChrW(269) & "un"
    UpsertRow lo, existing, "OTKUI_CIPN_BEZRAC", "Bez ra" & ChrW(269) & "una"
    UpsertRow lo, existing, "OTKUI_CIPN_AVANS", "Avans"
    UpsertRow lo, existing, "OTKUI_HDN_UKUPNO", "UKUPNO"
    UpsertRow lo, existing, "OTKUI_HDN_ISPLACENO", "ISPLA" & ChrW(262) & "ENO"
    UpsertRow lo, existing, "OTKUI_HDN_OTVORENO", "OTVORENO"
    UpsertRow lo, existing, "OTKUI_HDN_OTKID", "BLOK ID"
    UpsertRow lo, existing, "OTKUI_HDN_KOOPID", "KOOPERANT ID"
    UpsertRow lo, existing, "OTKUI_HDN_IMATR", "IMA RA" & ChrW(268) & "UN"
...
Private Sub UpsertPoruke10(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_BTN_BN_SPEC", "PDF specifikacija"
    UpsertRow lo, existing, "OTKUI_BTN_BN_OCISTI", "Isprazni izbor"
    UpsertRow lo, existing, "OTKUI_KPI_BN_OTVORENO", "Otvoreno RSD"
    UpsertRow lo, existing, "OTKUI_KPI_BN_UNALOZIMA", "U nalozima"
    ...
    UpsertRow lo, existing, "OTKUI_LBL_BN_AVANS_DOSTUPNO", "Dostupan avans:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_AVANS_VEZUJE", "Ve" & ChrW(382) & "e se pribl.:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_UKUPNO", "Ukupan iznos:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_SA_RACUNA", "Sa ra" & ChrW(269) & "una:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_VALUTA", "Datum valute:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_PRESKOCENO_TR", "Presko" & ChrW(269) & "eno (bez ra" & ChrW(269) & "una):"
    UpsertRow lo, existing, "OTKUI_LBL_BN_PRESKOCENO_MRTVO", "Presko" & ChrW(269) & "eno (vi" & ChrW(353) & "e nije otvoreno):"
    UpsertRow lo, existing, "OTKUI_ASK_BN_CSV", "Generisati naloge za prenos?  Broj naloga:"
    UpsertRow lo, existing, "OTKUI_ASK_BN_AVANS", "Vezati avans na blok"
    UpsertRow lo, existing, "OTKUI_ASK_BN_AVANS_KORPA", "Vezati avans na blokove iz korpe?"
    UpsertRow lo, existing, "OTKUI_LBL_BN_AVANS_BLOKOVA", "blokova sa raspolo" & ChrW(382) & "ivim avansom:"
    UpsertRow lo, existing, "OTKUI_MSG_BN_AVANS_ZBIR", ChrW(10003) & " Avans vezan na blokova:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_AVANS_BEZ", "bez promene:"
    UpsertRow lo, existing, "OTKUI_LBL_BN_AVANS_GRESKA", "gre" & ChrW(353) & "ka:"
    UpsertRow lo, existing, "OTKUI_ERR_BN_AVANS_OBIM", ChrW(10007) & " Izaberi red ili stavi blokove u korpu"
    UpsertRow lo, existing, "OTKUI_ERR_BN_AVANS_KORPA_NEMA", ChrW(10007) & " Nijedan blok iz korpe nema raspolo" & ChrW(382) & "iv avans i otvoren iznos"
    ...
    UpsertRow lo, existing, "OTKUI_MSG_BN_AVANS_NOOP", "Ni" & ChrW(353) & "ta nije proknji" & ChrW(382) & "eno: kooperant nema slobodan avans ili blok vi" & ChrW(353) & "e nije otvoren"
    UpsertRow lo, existing, "OTKUI_ERR_BN_DVOSMISLEN", ChrW(10007) & " Red nema jednozna" & ChrW(269) & "an identitet bloka"
    UpsertRow lo, existing, "OTKUI_ERR_BN_BEZ_RACUNA", ChrW(10007) & " Kooperant nema teku" & ChrW(263) & "i ra" & ChrW(269) & "un " & ChrW(8212) & " blok ne mo" & ChrW(382) & "e u naloge dok se ra" & ChrW(269) & "un ne upi" & ChrW(353) & "e u mati" & ChrW(269) & "ne podatke"
    UpsertRow lo, existing, "OTKUI_ERR_BN_VEC_U_NALOZIMA", "Blok je ve" & ChrW(263) & " u nalozima"
    UpsertRow lo, existing, "OTKUI_ERR_BN_NIJE_U_NALOZIMA", "Blok nije u nalozima"
    UpsertRow lo, existing, "OTKUI_ERR_BN_NEMA_AVANSA", ChrW(10007) & " Kooperant nema neraspore" & ChrW(273) & "en avans"
    UpsertRow lo, existing, "OTKUI_ERR_BN_NEMA_OTVORENOG", ChrW(10007) & " Blok nema otvoren iznos"
    UpsertRow lo, existing, "OTKUI_ERR_BN_AVANS", ChrW(10007) & " Gre" & ChrW(353) & "ka pri vezivanju avansa " & ChrW(8212) & " pogledajte log"
    UpsertRow lo, existing, "OTKUI_ERR_BN_NEMA_RACUNA", ChrW(10007) & " Izaberi ra" & ChrW(269) & "un sa koga ide isplata (Pode" & ChrW(353) & "avanja -> Banka / nalozi)"
    ...
    ' --- Ekran Izvestaji (modScrIzvestaji, v6-ui-186) ---
    UpsertRow lo, existing, "OTKUI_SCRIZ_SUB", "Pregledi za knjigovo" & ChrW(273) & "u, banku i vlasnika " & ChrW(8212) & " po entitetu i periodu"
    UpsertRow lo, existing, "OTKUI_SCRIZ_LISTA", "Izve" & ChrW(353) & "taji"
    UpsertRow lo, existing, "OTKUI_SCRIZ_CAP", "Izve" & ChrW(353) & "taji"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_SALDO", "Saldo"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_ROBA", "Roba"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_AMB", "Ambala" & ChrW(382) & "a"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_ISPL", "Isplata"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_ZBIR", "Zbirni"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_CENA", "Pros. cena"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_MANJAK", "Manjak"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_KART", "Kartica"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_AMBK", "Amb. kartica"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_RANG", "Rang"
    UpsertRow lo, existing, "OTKUI_SEG_IZ_OTKL", "Otk. listovi"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_SALDO", "Saldo"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_ROBA", "Otkupljena roba"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_AMB", "Ambala" & ChrW(382) & "a"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_ISPL", "Isplata"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_ZBIR", "Zbirni izve" & ChrW(353) & "taj"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_CENA", "Prose" & ChrW(269) & "na cena"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_MANJAK", "Manjak"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_KART", "Kartica kooperanta"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_AMBK", "Pregled ambala" & ChrW(382) & "e"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_RANG", "Rang kooperanata"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZ_OTKL", "Otkupni listovi"
    UpsertRow lo, existing, "OTKUI_CIPIZ_BEZPRIJ", "Bez prijema"
    UpsertRow lo, existing, "OTKUI_CIPIZ_ULAZ", "Ulaz"
    UpsertRow lo, existing, "OTKUI_CIPIZ_IZLAZ", "Izlaz"
    UpsertRow lo, existing, "OTKUI_SEGIZ_TIP_OM", "OM"
    UpsertRow lo, existing, "OTKUI_SEGIZ_TIP_KUP", "Kupci"
    UpsertRow lo, existing, "OTKUI_SEGIZ_TIP_VOZ", "Voza" & ChrW(269) & "i"
    UpsertRow lo, existing, "OTKUI_SEGIZ_TIP_KOOP", "Kooperanti"
    UpsertRow lo, existing, "OTKUI_SEGIZ_POJ", "Pojedina" & ChrW(269) & "no"
    UpsertRow lo, existing, "OTKUI_SEGIZ_ZBI", "Zbirno"
    UpsertRow lo, existing, "OTKUI_FLD_IZ_ENT", "Entitet"
    UpsertRow lo, existing, "OTKUI_FLD_IZ_OD", "Od"
    UpsertRow lo, existing, "OTKUI_FLD_IZ_DO", "Do"
    UpsertRow lo, existing, "OTKUI_BTN_IZ_PRINT", ChrW(352) & "tampaj izve" & ChrW(353) & "taj"
    UpsertRow lo, existing, "OTKUI_BTN_IZ_KARTPDF", ChrW(352) & "tampaj karticu (PDF)"
    UpsertRow lo, existing, "OTKUI_BTN_IZ_STAMPAJDOK", ChrW(352) & "tampaj dokument"
    UpsertRow lo, existing, "OTKUI_IZ_SVI", "Svi"
    ...
    UpsertRow lo, existing, "OTKUI_IZ_DET_OTKUP", "Otkupni list"
    UpsertRow lo, existing, "OTKUI_IZ_DET_OTPREMNICA", "Otpremnica"
    UpsertRow lo, existing, "OTKUI_IZ_DET_DOKUMENT", "Dokument"
    UpsertRow lo, existing, "OTKUI_IZ_DET_RED", "Detalj reda"
    UpsertRow lo, existing, "OTKUI_IZ_DET_IZNOS", "Iznos:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_VOZAC", "Voza" & ChrW(269) & ":"
    UpsertRow lo, existing, "OTKUI_IZ_DET_OTPKG", "Otpremljeno:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_BLOKOVA", "Otkupnih listova:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_ZBIRNA", "Zbirna:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_PRIJEMNICA", "Prijemnica"
    UpsertRow lo, existing, "OTKUI_IZ_DET_SORTA", "Sorta:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_AMB", "Ambala" & ChrW(382) & "a:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_AMB_VRAC", "vra" & ChrW(263) & "eno"
    UpsertRow lo, existing, "OTKUI_IZ_DET_FAKTURA", "Faktura:"
    UpsertRow lo, existing, "OTKUI_IZ_DET_NEFAKT", "nije fakturisana"
    ...
    UpsertRow lo, existing, "OTKUI_KPI_IZ_OMAVANS", "OM avans (nerasp.)"
    UpsertRow lo, existing, "OTKUI_KPI_IZ_AGRO", "Agro (nerasp.)"
    UpsertRow lo, existing, "OTKUI_KPI_IZ_OMAVANS_PRIM", "OM avans (primljeno)"
    UpsertRow lo, existing, "OTKUI_KPI_IZ_KOD_OTKUPCA", "Kod otkupca"
    UpsertRow lo, existing, "OTKUI_KPI_IZ_SALDO", "Saldo (kraj perioda)"
    UpsertRow lo, existing, "OTKUI_KPI_IZ_SALDOAMB", "Saldo amb. (gajbe)"
    UpsertRow lo, existing, "OTKUI_MSG_IZ_PRVO_PRIKAZI", ChrW(10007) & " Izve" & ChrW(353) & "taj jo" & ChrW(353) & " nije prikazan " & ChrW(8212) & " izaberi entitet i period pa poku" & ChrW(353) & "aj ponovo"
    UpsertRow lo, existing, "OTKUI_ERR_IZ_PRAZNO", ChrW(10007) & " Nema podataka za " & ChrW(353) & "tampu"
    UpsertRow lo, existing, "OTKUI_ERR_IZ_NEMA_DOK", ChrW(10007) & " Red nema dokument iza sebe " & ChrW(8212) & " agregat se ne " & ChrW(353) & "tampa po redu"
    UpsertRow lo, existing, "OTKUI_ERR_IZ_STAMPA_NEDOSTUPNA", "Za ovu vrstu reda " & ChrW(353) & "tampa nije dostupna iz ovog pregleda"
    UpsertRow lo, existing, "OTKUI_HDI_VRSTA", "VRSTA"
    UpsertRow lo, existing, "OTKUI_HDI_NOVAC", "NOVAC"
    UpsertRow lo, existing, "OTKUI_HDI_SALDO", "SALDO"
    UpsertRow lo, existing, "OTKUI_HDI_AMB", "AMB"
    UpsertRow lo, existing, "OTKUI_HDI_ISPLACENO", "ISPLA" & ChrW(262) & "ENO"
    UpsertRow lo, existing, "OTKUI_HDI_AGRO", "AGRO"
    UpsertRow lo, existing, "OTKUI_HDI_BROTP", "OTPREMNICA"
    UpsertRow lo, existing, "OTKUI_HDI_KLASA", "KL."
    UpsertRow lo, existing, "OTKUI_HDI_VOZAC", "VOZA" & ChrW(268)
    UpsertRow lo, existing, "OTKUI_HDI_OTPKG", "OTP KG"
    UpsertRow lo, existing, "OTKUI_HDI_BLOKKG", "BLOKOVI KG"
    UpsertRow lo, existing, "OTKUI_HDI_RAZLIKA", "RAZLIKA"
    UpsertRow lo, existing, "OTKUI_HDI_PRIJKG", "PRIJEMNICA"
    UpsertRow lo, existing, "OTKUI_HDI_MANJKG", "MANJAK KG"
    UpsertRow lo, existing, "OTKUI_HDI_MANJPCT", "MANJAK %"
    UpsertRow lo, existing, "OTKUI_HDI_REF", "REF"
    UpsertRow lo, existing, "OTKUI_HDI_NR", "NR"
    UpsertRow lo, existing, "OTKUI_HDI_MESTO", "MESTO"
    UpsertRow lo, existing, "OTKUI_HDI_DOKUMENT", "DOKUMENT"
    UpsertRow lo, existing, "OTKUI_HDI_DOKTIP", "DOK TIP"
...
Private Sub UpsertPoruke11(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_HDI_AMBIZLAZ", "AMB IZLAZ"
    UpsertRow lo, existing, "OTKUI_HDI_AMBVRAC", "AMB VRA" & ChrW(262) & "ENA"
    UpsertRow lo, existing, "OTKUI_HDI_PROSEK", "PROSEK"
    UpsertRow lo, existing, "OTKUI_HDI_PROSCENA", "PROS. CENA"
    UpsertRow lo, existing, "OTKUI_HDI_BRZBIRNE", "BR. ZBIRNE"
    UpsertRow lo, existing, "OTKUI_HDI_ZBIRKG", "ZBIRNA KG"
    UpsertRow lo, existing, "OTKUI_HDI_PROSEKGAJBE", "PROSEK GAJBE"
    UpsertRow lo, existing, "OTKUI_HDI_BRDOK", "BROJ DOK."
    UpsertRow lo, existing, "OTKUI_HDI_OPIS", "OPIS"
    UpsertRow lo, existing, "OTKUI_HDI_ZAD", "ZADU" & ChrW(381) & "ENJE"
    UpsertRow lo, existing, "OTKUI_HDI_RAZD", "RAZDU" & ChrW(381) & "ENJE"
    UpsertRow lo, existing, "OTKUI_HDI_SALDOAMB", "SALDO AMB."
    ' --- Ekran SLEDLJIVOST (v6-ui-187) ---
    UpsertRow lo, existing, "OTKUI_SCRSL_CAP", "Sledljivost"
    UpsertRow lo, existing, "OTKUI_SCRSL_SUB", "Lanac dokumenata: otkup " & ChrW(8212) & " otpremnica " & ChrW(8212) & " zbirna " & ChrW(8212) & " prijemnica " & ChrW(8212) & " faktura"
    UpsertRow lo, existing, "OTKUI_SCRSL_LISTA", "Lanac dokumenata"
    UpsertRow lo, existing, "OTKUI_SEG_SL_LANAC", "Lanac"
    UpsertRow lo, existing, "OTKUI_SEG_SL_PARC", "Po parceli"
    UpsertRow lo, existing, "OTKUI_SEG_SL_NEP", "Nepotpuni"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_SL_LANAC", "Lanac dokumenata"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_SL_PARC", "Sledljivost po parceli"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_SL_NEP", "Nepotpune karike"
    UpsertRow lo, existing, "OTKUI_CIPSL_POTPUN", "Potpun lanac"
    UpsertRow lo, existing, "OTKUI_CIPSL_NEPOTPUN", "Nepotpun"
    UpsertRow lo, existing, "OTKUI_CIPSL_BEZPARC", "Bez parcele"
    UpsertRow lo, existing, "OTKUI_CIPSL_VEZE", "Veze"
    UpsertRow lo, existing, "OTKUI_CIPSL_PRIJEM", "Prijem"
    UpsertRow lo, existing, "OTKUI_CIPSL_FAKTURE", "Fakture"
    UpsertRow lo, existing, "OTKUI_CIPSL_KG", "Kg razlike"
    UpsertRow lo, existing, "OTKUI_HDS_PRIJEM", "PRIJEM"
    UpsertRow lo, existing, "OTKUI_HDS_FAKTURA", "FAKTURA"
    UpsertRow lo, existing, "OTKUI_HDS_KUPAC", "KUPAC"
    UpsertRow lo, existing, "OTKUI_HDS_OZNAKA", "OZNAKA"
    UpsertRow lo, existing, "OTKUI_HDS_BPG", "BPG"
    UpsertRow lo, existing, "OTKUI_HDS_KATBROJ", "KAT. BROJ"
    UpsertRow lo, existing, "OTKUI_HDS_KULTURA", "KULTURA"
    UpsertRow lo, existing, "OTKUI_HDS_POVRSINA", "HA"
    UpsertRow lo, existing, "OTKUI_HDS_GGAP", "GGAP"
    ...
    UpsertRow lo, existing, "OTKUI_SL_HINT", "Pretraga nalazi svaki broj u lancu: otkup, otpremnicu, zbirnu, prijemnicu, fakturu, kooperanta, kupca."
    UpsertRow lo, existing, "OTKUI_SL_HINT_PRAZNO", "Nema otkupa u izabranom periodu " & ChrW(8212) & " pro" & ChrW(353) & "iri period u poljima iznad."
    UpsertRow lo, existing, "OTKUI_SL_HINT_SVIPOTPUNI", "Sve karike u periodu su potpune " & ChrW(8212) & " nema nijednog nalaza."
    UpsertRow lo, existing, "OTKUI_SL_PERIOD", "period:"
    UpsertRow lo, existing, "OTKUI_SLP_BEZOTP", "Otkup bez otpremnice"
    UpsertRow lo, existing, "OTKUI_SLP_VEZA", "Veza neusagla" & ChrW(353) & "ena"
    ...
    UpsertRow lo, existing, "OTKUI_MSG_SL_PRINT_OFF", ChrW(352) & "tampa sledljivosti je isklju" & ChrW(269) & "ena (SLEDLJIVOST_PRINT_MODE = OFF)"
    UpsertRow lo, existing, "OTKUI_SL_DET_KARIKA_OTKUP", "Otkup"
    UpsertRow lo, existing, "OTKUI_SL_DET_KUPAC", "Kupac:"
    UpsertRow lo, existing, "OTKUI_SL_DET_PARCELA", "Parcela:"
