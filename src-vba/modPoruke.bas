...
Public Sub UpsertPoruke(lo As ListObject)
    ...
    UpsertRow lo, existing, "OTKUI_HDB_BIMID", "STAVKA"
    ...
    UpsertRow lo, existing, "OTKUI_HDB_STAVKI", "STAVKI"
    UpsertRow lo, existing, "OTKUI_HDB_OTVORENIH", "OTVORENIH"
    ...
    UpsertRow lo, existing, "OTKUI_LBL_BU_HINT", "Izaberi red pa radnju. Ru" & ChrW(269) & "no mapiranje koristi polja iznad."
    UpsertRow lo, existing, "OTKUI_LBL_BU_HINT_AVANS", "Bez izabrane fakture uplata se knji" & ChrW(382) & "i kao AVANS kupca."
    UpsertRow lo, existing, "OTKUI_LBL_BU_HINT_BLOK", "Bez izabranog bloka uzima se poziv na broj iz izvoda."
    UpsertRow lo, existing, "OTKUI_LBL_BU_HINT_OM", "Za OM se ne bira ni faktura ni blok."
    UpsertRow lo, existing, "OTKUI_LBL_BU_NASLOV_ZA", "za obradu"
