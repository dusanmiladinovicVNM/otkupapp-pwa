...
Private Sub UpsertPoruke04(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_SUB_ZBIRNA", "Objedinjavanje izdatih otpremnica u jednu zbirnu"
    ...
    UpsertRow lo, existing, "OTKUI_HINT_ZBIRNA", "otpremnice " & ChrW(269) & "ekaju zbirnu"
    ...
    UpsertRow lo, existing, "OTKUI_SEG_LS_ZBR", "Zbirne"
    UpsertRow lo, existing, "OTKUI_SEG_LS_IZVORI", "U sastavu"
    UpsertRow lo, existing, "OTKUI_SEG_LS_NEVEZ_OTP", "Bez zbirne"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_ZBR_NACRTI", "Nacrti zbirnih"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_IZVORI", "Otpremnice u sastavu"
    UpsertRow lo, existing, "OTKUI_GRID_TITLE_NEVEZANE_OTP", "Izdate otpremnice bez zbirne"
    UpsertRow lo, existing, "OTKUI_MSG_ZBR_AKTIVNA", "Aktivan nacrt zbirne:"
    UpsertRow lo, existing, "OTKUI_ERR_NEMA_AKT_ZBR", ChrW(10007) & " Nema izabranog nacrta zbirne " & ChrW(8212) & " izaberi ga u listi Zbirne."
    UpsertRow lo, existing, "OTKUI_ERR_VEZA_ZBR", ChrW(10007) & " Otpremnica nije vezana za zbirnu:"
    UpsertRow lo, existing, "OTKUI_ERR_UKLONI_ZBR", ChrW(10007) & " Otpremnica nije uklonjena iz zbirne:"
    UpsertRow lo, existing, "OTKUI_ERR_IZDAJ_ZBR", ChrW(10007) & " Zbirna nije izdata:"
...
Private Sub UpsertPoruke06(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "DOKUNOS_ERR_ZBR_GAJBE_BEZ_KG", ChrW(10007) & " Gajbe su unete bez kila" & ChrW(382) & "e. Unesi kila" & ChrW(382) & "u ili obri" & ChrW(353) & "i gajbe " & ChrW(8212) & " 0 kg zna" & ChrW(269) & "i da te klase nema."
...
Private Sub UpsertPoruke08(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "OTKUI_OTP_NAJAVLJENO", "Najavljeno kg"
    UpsertRow lo, existing, "OTKUI_OTP_POVEZANO", "U otpremnicama"
    UpsertRow lo, existing, "OTKUI_OTP_IZVORA", "Izvora"
    ...
    UpsertRow lo, existing, "OTKUI_BTN_RED_VEZI", "Ve" & ChrW(382) & "i za otpremnicu"
    UpsertRow lo, existing, "OTKUI_BTN_RED_UKLONI", "Ukloni iz otpremnice"
    UpsertRow lo, existing, "OTKUI_BTN_RED_IZDAJ", "Izdaj otpremnicu"
    UpsertRow lo, existing, "OTKUI_OTP_ST_NACRT", "Nacrt"
    UpsertRow lo, existing, "OTKUI_OTP_ST_IZDATA", "Izdata"
    UpsertRow lo, existing, "OTKUI_ERR_OTP_IZDATA", "Otpremnica je izdata " & ChrW(8212) & " ne prima nove blokove."
    UpsertRow lo, existing, "OTKUI_ERR_OTP_NEPOZNATA", "Otpremnica nije prona" & ChrW(273) & "ena ili je stornirana."
    UpsertRow lo, existing, "OTKUI_ERR_NEMA_AKT_OTP", "Nema izabrane otpremnice " & ChrW(8212) & " izaberi nacrt u listi Otpremnice."
    UpsertRow lo, existing, "OTKUI_ERR_VEZA_OTP", "Otkup NIJE vezan za otpremnicu:"
    UpsertRow lo, existing, "OTKUI_MSG_VEZAN", "Vezan za otpremnicu"
    UpsertRow lo, existing, "OTKUI_ERR_UKLONI", "Otkup nije uklonjen iz otpremnice:"
    UpsertRow lo, existing, "OTKUI_MSG_UKLONJEN", "Uklonjen iz otpremnice"
    UpsertRow lo, existing, "OTKUI_ASK_IZDAJ", "Izdati otpremnicu"
    UpsertRow lo, existing, "OTKUI_ASK_IZDAJ2", "? Posle izdavanja sastav se vi" & ChrW(353) & "e ne menja, a izlaz gajbi se knji" & ChrW(382) & "i."
    UpsertRow lo, existing, "OTKUI_MSG_IZDATA", "Izdata otpremnica"
    UpsertRow lo, existing, "OTKUI_ERR_AUTOZBR", "Otpremnica je izdata, ali auto-zbirna nije napravljena:"
    UpsertRow lo, existing, "OTKUI_ERR_IZDAJ", "Otpremnica nije izdata:"
    UpsertRow lo, existing, "OTKUI_MSG_IZMENA_NACRTA", "Izmena nacrta " & ChrW(8212) & " snimanje menja ovaj nacrt:"
