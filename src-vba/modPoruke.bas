...
Private Sub UpsertPoruke05(lo As ListObject, existing As Object)
    ...
    UpsertRow lo, existing, "DOKUNOS_ERR_PRIJEMNICA_PAUZIRANA", "Unos prijemnice je PAUZIRAN dok zbirna ne pre" & ChrW(273) & "e na nov model: prijemnica tra" & ChrW(382) & "i zbirnu, a nova zbirna se jo" & ChrW(353) & " ne mo" & ChrW(382) & "e uneti."
