...
SABOTAZE = {
    ...
    # sledljivost-zona-bez-dugmeta: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-pdf-bez-oznake: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-mete-storniranu-paletu: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-mete-preradjena-kao-sveza: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-lanac-pretraga-bez-refs: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-gp-refs-progutani: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    ...
    # sledljivost-gp-stanje-placebo: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-gp-siroce-cuti: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    ...
    # sledljivost-gp-faktura-ne-preuzima: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-dokumenti-nevalidan-datum-skriven: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    ...
    # sledljivost-pdf-dvotacka: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-nep-pretraga-bez-lanca: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
    # sledljivost-dokumenti-preradjena-kao-sveza: obrisana u S1b-3 (ekran SLEDLJIVOST na vezi Otkup.OtpremnicaID; vraca S9).
