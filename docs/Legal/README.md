...
| `AgriX_Ugovor_o_licenciranju.docx` | nacrt · 26.07.2026. | Ugovor o licenciranju softvera i pružanju pratećih usluga za AgriX Enterprise: 15 članova + Prilog 1 (obim i cene), Prilog 2 (podrška), Prilog 3 (obrada podataka o ličnosti). |
...
- nepopunjena polja: vremenski prozor za rok reakcije od jednog sata (odluka 359, Prilog 2), mesto nadležnog suda (član 15), spisak drugih obrađivača i lokacija obrade (odluka 373);
- cene u Prilogu 1 preuzete su iz odluka 349–357 i moraju ostati identične sa `docs/Sales/AgriX_Cenovnik_2027.pdf`; hardverska podrška (odluka 357) je i dalje predlog.
