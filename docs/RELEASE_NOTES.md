...
- **Podešavanja — preuređene grupe:** redosled „operativno gore → tehnika dole" (Prodavac, Otkup/dokumenta, Malina režim, Management/Klijent, SEF, pa Monitoring, Sinhronizacija, Google, Alati, Napredno); **Licenca** i **Probni period** spojeni u **Management/Klijent**. U „Otkup/dokumenta" srodni toggle-i su grupisani — štampa (otkupni/paletni/prijemnica) zajedno, a mehanizam izrade dokumenata (auto-broj/paletiranje/auto-prijemnica) zajedno.
