...
- **Rizik za podatke:** nizak — dopuna šeme je aditivna (nove kolone), postojeći tokovi netaknuti. Odloženo za sledeći PR: append-only re-verzionisanje zbirne (korak 3.2), „Vrati storno" (undo) dorada. ASCII-only izvori; `.frx` netaknut.
