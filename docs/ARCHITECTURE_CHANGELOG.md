...
Reference updated: Companion `AMBALAZA_MODEL.md` (§3 Klasa II knjiži svoju ambalažu; §9 storno celog dokumenta). Main `ARCHITECTURE_REFERENCE.md` — TBD.
